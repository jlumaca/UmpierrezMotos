...
def vista_clientes(req):
    clientes = Cliente.objects.filter(
        cliente_telefono__principal=True,tipo="Cliente"
    ).values('id','nombre', 'apellido', 'cliente_telefono__telefono').order_by('nombre')

    empresas = Cliente.objects.filter(
        cliente_telefono__principal=True,tipo="Empresa"
    ).values('id','nombre', 'apellido', 'cliente_telefono__telefono').order_by('nombre')

    page_obj = funcion_paginas_varias(req,clientes)
    page_obj_empresas = funcion_paginas_varias(req,empresas)
    return render(req,"perfil_administrativo/cliente/clientes.html",{'page_obj': page_obj,"clientes":clientes,"page_obj_empresas":page_obj_empresas})
...
def alta_empresa(req):
    try:
        if req.method == "POST":
            ...
            existe_cliente = valid_cliente(doc_compuesto)
            if existe_cliente == "existe_cliente":
                return render(req,"perfil_administrativo/cliente/alta_empresa.html",{"error_message":"El cliente ya existe"})
            # elif existe_cliente == "existe_telefono_1":
            #     return render(req,"perfil_administrativo/cliente/alta_cliente.html",{"error_message":"El telefono 1 ya existe"})
            # elif existe_cliente == "existe_telefono_2":
            #     return render(req,"perfil_administrativo/cliente/alta_cliente.html",{"error_message":"El telefono 2 ya existe"})
            ...
            # elif existe_cliente == "existe_correo_2":
                ...
                return render(req,"perfil_administrativo/cliente/alta_empresa.html",{"error_message":"Los numeros de teléfono no pueden ser iguales"})
            elif (correo_principal and correo_secundario) and (correo_principal == correo_secundario):
                return render(req,"perfil_administrativo/cliente/alta_empresa.html",{"error_message":"Los correos no pueden ser iguales"})
            else:
                # if localidad == "Otro":
                #     ciudad = req.POST['localidad_otro'].title()
                # else:
                ...
                if correo_secundario:
                    correo_secundario = correo_secundario.lower()
                    insert_cliente_correo(correo_secundario,0,nuevo_cliente.id)
                messages.success(req, "La empresa fue ingresada con éxito.")
                return redirect('Clientes')
        else:
            return render(req,"perfil_administrativo/cliente/alta_empresa.html",{})
    except Exception as e:
        pass
...
@admin_required
def modificacion_empresa(req,id_cliente):
    try:
        if req.method == "POST":
            tipo_doc = "RUT"
            doc = req.POST['doc']
            ...
            valid_cliente = valid_cliente_mod(id_cliente,documento)
            if valid_cliente == "existe_cliente":
                contexto = contexto_para_cliente(id_cliente,"El RUT ingresado ya existe")
                return render(req,"perfil_administrativo/cliente/modificacion_empresa.html",contexto)
            ...
            #     return render(req,"perfil_administrativo/cliente/modificacion_cliente.html",contexto)
                ...
                mod_cliente.save()
                messages.success(req, "Empresa modificada con éxito")
                return redirect('Clientes')
        else:
            contexto = contexto_para_cliente(id_cliente,None)
            return render(req,"perfil_administrativo/cliente/modificacion_empresa.html",contexto)
    except Exception as e:
        return render(req,"perfil_administrativo/cliente/modificacion_empresa.html",{"error_message":e})
...
def clientes_taller(req):
    ...
    page_obj_empresas = funcion_paginas_varias(req,empresas)
    return render(req,"perfil_taller/clientes/clientes.html",{'page_obj': page_obj,"clientes":clientes,"page_obj_empresas":page_obj_empresas})
...
def buscar_por_rut_taller(req):
    ...
    return render(req,"perfil_taller/clientes/clientes.html",{'page_obj': page_obj_cli,"page_obj_empresas":page_obj_emp})


def buscar_nom_emp_taller(req):
    nombre = req.GET.get('nombre')
    apellido = ""
    ...
    page_obj = funcion_paginas_varias(req,clientes)  # Obtiene la página solicitada
    page_obj_emp = funcion_paginas_varias(req,empresa)
    return render(req,"perfil_taller/clientes/clientes.html",{'page_obj': page_obj,"page_obj_empresas":page_obj_emp})
...
def alta_empresa_taller(req):
    # try:
        if req.method == "POST":
            ...
            existe_cliente = valid_cliente(doc_compuesto)
            if existe_cliente == "existe_cliente":
                return render(req,"perfil_taller/clientes/alta_empresa.html",{"error_message":"El cliente ya existe"})
            # elif existe_cliente == "existe_telefono_1":
            #     return render(req,"perfil_administrativo/cliente/alta_cliente.html",{"error_message":"El telefono 1 ya existe"})
            # elif existe_cliente == "existe_telefono_2":
            #     return render(req,"perfil_administrativo/cliente/alta_cliente.html",{"error_message":"El telefono 2 ya existe"})
            ...
            # elif existe_cliente == "existe_correo_2":
                ...
                return render(req,"perfil_taller/clientes/alta_empresa.html",{"error_message":"Los numeros de teléfono no pueden ser iguales"})
            elif (correo_principal and correo_secundario) and (correo_principal == correo_secundario):
                return render(req,"perfil_taller/clientes/alta_empresa.html",{"error_message":"Los correos no pueden ser iguales"})
            else:
                # if localidad == "Otro":
                #     ciudad = req.POST['localidad_otro'].title()
                # else:
            ...
            return render(req,"perfil_taller/clientes/alta_empresa.html",{})
    # except Exception as e:
    #     pass
...
def modificacion_empresa_taller(req,id_cliente):
    try:
        if req.method == "POST":
            tipo_doc = "RUT"
            doc = req.POST['doc']
            ...
            if valid_cliente == "existe_cliente":
                contexto = contexto_para_cliente(id_cliente,"El RUT ingresado ya existe")
                return render(req,"perfil_taller/clientes/modificacion_empresa.html",contexto)
        ...
        return render(req,"perfil_taller/clientes/modificacion_empresa.html",{"error_message":e})
...
def modificacion_moto_taller(req,id_moto):
    # try:
        if req.method == "POST":
                moto_upd = Moto.objects.get(id=id_moto)
                checkbox_num_motor = 'con_num_motor' in req.POST
                ...
                if validacion_datos_moto == "existe_num_motor":
                    return render(req,"perfil_taller/motos/modificacion_moto.html",{"error_message":"El número de motor ya se encuentra asignado a otra moto",
                                                                                            'datos_moto': moto_upd,
                                                                                            "letras_matricula":letras_matricula,
                                                                                            "num_matricula":num_matricula,
                                                                                            "precio":precio,
                    ...
                    return render(req,"perfil_taller/motos/modificacion_moto.html",{"error_message":"El número de chasis ya se encuentra asignado a otra moto",
                                                                                            'datos_moto': moto_upd,
                                                                                            "letras_matricula":letras_matricula,
                                                                                            "num_matricula":num_matricula,
                                                                                            "precio":precio,
                    ...
                    return render(req,"perfil_taller/motos/modificacion_moto.html",{"error_message":"La matricula ingresada ya existe",
                                                                                            'datos_moto': moto_upd,
                                                                                            "letras_matricula":letras_matricula,
                                                                                            "num_matricula":num_matricula,
                                                                                            "precio":precio,
                                                                                            "active_page": 'Motos'}) 
                elif (req.POST['num_padron']) and (validar_matricula == "padron_existe") and (int(padron) != 0):
                    return render(req,"perfil_taller/motos/modificacion_moto.html",{"error_message":"El número de padrón ya existe",
                                                                                            'datos_moto': moto_upd,
                                                                                            "letras_matricula":letras_matricula,
                                                                                            "num_matricula":num_matricula,
                                                                                            "precio":precio,
                    ...
                    return render(req,"perfil_taller/motos/modificacion_moto.html",{"error_message":"La matrícula es incorrecta",
                                                                                            'datos_moto': moto_upd,
                                                                                            "letras_matricula":letras_matricula,
                                                                                            "num_matricula":num_matricula,
                                                                                            "precio":precio,
            ...
            if matricula_upd:
                letras_matricula = matricula_upd.matricula[0:3:1]
                num_matricula = matricula_upd.matricula[3:7:1]
                padron = matricula_upd.padron if matricula_upd.padron else 0
            else:
                letras_matricula = None
                num_matricula = None
                padron = 0
            ...
            if moto_upd.observaciones == None:
                moto_upd.observaciones = "Sin descripción"
            precio = int(moto_upd.precio) if moto_upd.precio else 0
            return render(req,"perfil_taller/motos/modificacion_moto.html",{'datos_moto': moto_upd,
            "letras_matricula":letras_matricula,
            "num_matricula":num_matricula,
            "padron":padron,
            "precio":precio,
...
def detalles_moto_taller(req,id_moto):
    # try:
        moto = Moto.objects.get(id=id_moto)
        matricula = Matriculas.objects.filter(moto_id=id_moto).first()
        matr_actual = matricula.matricula if matricula else None
        ...
        page_obj = funcion_paginas_varias(req,servicios_moto)
        return render(req,"perfil_taller/motos/detalles_moto.html",{"page_obj":page_obj,"moto":moto,"matr_actual":matr_actual})                                                          
                                                                   
    # except Exception as e:
    #     pass

def servicios_de_la_moto(req,id_s,id_cliente):
    contexto = contexto_modificar_servicio(id_s,None)
    datos = json_para_servicio(id_s)
    return render(req,"perfil_taller/motos/detalles_servicio.html",{ "moto":contexto[0],
                                                                            "cliente":contexto[1],
                                                                            "matricula":contexto[2],
                                                                            "telefono":contexto[3],
                                                                            "correo":contexto[4],

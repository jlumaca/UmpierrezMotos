...
urlpatterns = [
     ...
     path('servicios_por_moto/<int:id_moto>', views.servicios_por_moto_de_cliente,name="ServiciosPorMoto"),
     path('detalles_por_servicio/<int:id_s>', views.detalle_de_cada_servicio_de_moto,name="DetallesPorServicios"),
